...
export default function Home() {
  ...
  const filteredProducts = products.filter((p) => {
    // Remove coming soon from main list
    if (p.status === 'coming') return false;
  ...
  return (
    <div>
      <SEO
        title="Wingsforshare - Software, Web, App & Growth Agency"
        description="Wingsforshare helps businesses scale through custom software and high-performance web development."
      />
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] lg:text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-wider">Top rankings</span>
                      </div>
                    </div>
                    <MiniSEOMockup />
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] lg:text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-wider">Data insights</span>
                      </div>
                    </div>
                    <MiniBIMockup />
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] lg:text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-wider">iOS & Android</span>
                      </div>
                    </div>
                    <MiniAppMockup />
                  </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="mb-6">
            <input
              ...
              className="w-full p-3 border rounded-lg bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
              ...
              {['all', 'web', 'app'].map((cat) => (
                <button
                  ...
                  className={`px-3 py-1 rounded capitalize font-medium transition-colors ${
                    filter === cat ? 'bg-emerald-500 text-white' : 'bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-700'
                  }`}
                >
                  {cat}
                </button>
