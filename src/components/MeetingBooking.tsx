...
export default function MeetingBooking() {
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="bg-black dark:bg-white text-white dark:text-black p-8 md:p-12 rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] dark:shadow-[0_32px_64px_-16px_rgba(255,255,255,0.05)] relative overflow-hidden group"
    >
