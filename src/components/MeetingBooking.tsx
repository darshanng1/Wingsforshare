...
export default function MeetingBooking() {
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="bg-black dark:bg-white text-white dark:text-black p-8 md:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden"
    >
      <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl -z-10" />
      
      <div className="mb-10">
        <div className="inline-flex items-center space-x-2 bg-white/10 dark:bg-black/10 px-4 py-2 rounded-full mb-6">
        ...
        <h3 className="text-4xl font-bold tracking-tighter mb-4">Book a Project Strategy Session</h3>
