...
import { Send, CheckCircle, MessageSquare, Phone, User, Building2, Briefcase } from 'lucide-react';
...
Message: ${formData.message}`;
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="bg-white dark:bg-[#111] p-8 md:p-12 rounded-[3rem] border border-black/5 dark:border-white/10 shadow-2xl"
    >
      <div className="mb-10">
        <h3 className="text-3xl font-bold text-black dark:text-white mb-2">Book a Consultation</h3>
        <p className="text-black/40 dark:text-white/40 font-medium">Let's discuss how we can help your business grow.</p>
      </div>
