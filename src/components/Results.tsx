...
export default function Results() {
  ...
  return (
    <section className="section-padding bg-emerald-500 text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-emerald-100 opacity-80">
                {stat.label}
              </p>
            </motion.div>
          ))}
